...
export default function Policy() {
  return (
    <Layout>
      <Seo
        title="AstroFi Terms of Use"
        description="Terms of use for the AstroFi websites"
      />
      <Section center>
        <div style={{ maxWidth: "600px" }}>
          ...
          <Paragraph>
            <strong>
              PLEASE READ THESE TERMS OF USE BEFORE USING THE WEBSITES AND
              APPLICATIONS PROVIDED BY ASTROFI.
            </strong>
          </Paragraph>
          <Paragraph>
            Acceptance of the Terms of Use These terms of use are entered into
            by and between you and the developers &amp; contributors of the
            AstroFi protocol (&quot;Foundation&quot;, &quot;we&quot; or
            ...
            astrofi.io, including any content, functionality and services
            offered on or through astrofi.io or app.astrofi.io (together, the
            &quot;Website&quot;).
          </Paragraph>
          <Paragraph>
          ...
          <ul>
            <li>
              our <a href="https://astrofi.io/disclaimer/">Disclaimer</a>,
          ...
          <Paragraph>
            <strong>Who May Use the Websites</strong>
          </Paragraph>
          <Paragraph>
            ...
            you (i) are 13 years of age or older, and (ii) are not barred to use
            the Websites under any applicable law. If you do not meet these
          ...
          <Paragraph>
            <strong>Accessing the Websites and Account Security</strong>
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            ...
            arrangement thereof), are owned by AstroFi, its licensors or other
          ...
          <Paragraph>
            The Foundation name, the terms AstroSale, XAI token, the Foundation
          ...
          <ul>
            ...
            <li>
              ...
              determined by us, may harm the Foundation or users of the Websites
          ...
          <ul>
            ...
            <li>
              ...
              to access the Websites for any purpose, including monitoring or
              copying any of the material on the Websites.
            </li>
            <li>
          ...
          <Paragraph>
            <strong>Changes to the Websites</strong>
          </Paragraph>
          <Paragraph>
            We may update the content on this Websites from time to time in our
            sole discretion, but its content is not necessarily complete or
            up-to-date. Any of the material on the Websites may be out of date
          ...
          <Paragraph>
            As AstroFi is a fully decentralised protocol, the AstroFi Websites
            do not collect data about their users.
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            <strong>Linking to the Websites and Social Media Features</strong>
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            <strong>Links from the Websites</strong>
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            The owner of the Websites is based in Germany. We make no claims
            that the Websites or any of its content is accessible or appropriate
            outside of Germany. Access to the Websites may not be legal by
          ...
          <Paragraph>
            ...
            NEITHER THE FOUNDATION NOR ANY PERSON ASSOCIATED WITH THE FOUNDATION
            ...
            REPRESENTS OR WARRANTS THAT THE WEBSITE, ITS CONTENT OR ANY SERVICES
            OR ITEMS OBTAINED THROUGH THE WEBSITES WILL BE ACCURATE, RELIABLE,
            ...
            OR OTHER HARMFUL COMPONENTS OR THAT THE WEBSITES OR ANY SERVICES OR
          ...
          <Paragraph>
            ...
            use of the Website, including, but not limited to, any use of the
          ...
          <Paragraph>
            ...
            in Bavaria, Germany, although we retain the right to bring any suit,
          ...
          <Paragraph>
            ...
            <a href="mailto:support@astrofi.io">support@astrofi.io</a>.
          </Paragraph>
        </div>
      </Section>
    </Layout>
